...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark pt-0 pb-0">
    <a class="navbar-brand" href="{{ url('/') }}">RemoAuto</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('/sukurti-uzduoti') }}"><i class="fas fa-hammer"></i> Sukurti Užduotį</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('/uzduociu-valdymas') }}"><i class="fas fa-tasks"></i> Užduočių Valdymas</a>
            </li>
        </ul>
